...
// print_r($row_produtos); // serve pra mostrar o coneúdo da matriz retoenadada do banco
?>
...
<?php if ($num_linhas > 0){ ?>
  ...
  <div class="row"> 
    <?php do { ?>
      <div class="col-sm-6 col-md-3 bg-success"> 
         <div class="thumbnail  ">
            <a href="produtos_detalhes.php?id=<?php echo $row_produtos['id'] ?>">
